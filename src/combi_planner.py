...
class CombiPlanner:
    ...
    def __init__(self, scene, show_plot=False):
        ...
        self.pressure_computer = GridComputer(self.scene, False, True, True)
        self.pressure_computer.smoothing_length = self.scene.core_distance
