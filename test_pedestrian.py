...
class TestPedestrian:
    ...
    def test_pedestrian_location(self):
        print("testing the pedestrian")
        ped = Pedestrian(self.scene,1,self.scene.obs_list[-1])
        assert all(ped.position.array < self.scene.size.array)
